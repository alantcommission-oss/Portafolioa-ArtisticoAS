    ...
    <div className="page visible z-10 overflow-y-auto">
      <div className="min-h-screen flex flex-col">
        ...
        <div className="flex items-center gap-4 px-6 pt-6 pb-2 shrink-0">
          ...
          <h2 className="font-heading text-sm tracking-[5px] text-[var(--mag)] uppercase">
            {t("gallery_title")}
          </h2>
        </div>
                ...
                {filtered.map((art) => {
                  ...
                  return (
                    <div
                      ...
                      className="break-inside-avoid rounded border border-[#2a1a20] hover:border-[var(--mag)] md:hover:scale-[1.4] hover:z-10 transition-all duration-300 cursor-pointer group relative"
                    >
